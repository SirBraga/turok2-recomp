    ...
    namespace config {
        namespace general {
            ...
            namespace options {
                ...
                inline const std::string analog_look = "analog_look";
            ...
            bool has_analog_look_option();
            bool get_analog_look();
        ...
        namespace graphics {
            ...
            namespace options {
                ...
                inline const std::string filtering_option = "filtering_option";
                inline const std::string dither_option = "dither_option";
                inline const std::string upscale_2d_option = "upscale_2d_option";
                inline const std::string hud_scale = "hud_scale";
            ...
            Upscale2D get_upscale_2d();
            double get_hud_scale();
        ...
        struct GeneralTabOptions {
            ...
            bool has_analog_look = false;
            // < 0 keeps the Zelda-style default (Steam Deck 50%, otherwise 0%).
            double mouse_sensitivity_default = -1.0;
            double joystick_deadzone_default = 5.0;
        };
